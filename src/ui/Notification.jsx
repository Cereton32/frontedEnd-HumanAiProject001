...
const Notification = ({ message, type = 'info', duration = 5000 }) => {
  ...
  return (
    <div className={`fixed top-4 right-4 z-50 ${typeClasses[type]} rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'}`}>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-1 bg-current opacity-25">
        <div 
